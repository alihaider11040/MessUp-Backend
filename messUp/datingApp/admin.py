...
from .models import Institute, Profile, Country, Profession, SexualOrientation, Zodiac,Interests,MatchMake,Login,BlockProfile, PictureGallery,InterestsID, BodyType, Notifications
